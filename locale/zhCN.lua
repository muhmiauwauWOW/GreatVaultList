...
L["opt_CharacterList_show"] = "显示"
L["opt_CharacterList_ignore"] = "忽略"
L["opt_CharacterList_delete"] = "删除数据"
L["opt_CharacterList_delete_confirm"] = "确定要删除角色 %s 的数据吗？此操作无法撤销。"
L["opt_CharacterList_unknown_realm"] = "未知服务器"
